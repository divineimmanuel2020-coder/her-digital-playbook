...
async function init() {
  ...
  if (!item) {
    container.innerHTML = `
      <div class="article-empty">
        ...
        <a class="btn btn-primary mt-lg" href="../">Back to Home</a>
      </div>`;
    return;
  }
  ...
  // Self-referencing canonical URL, built from the item's own id —
  // this means every article/tool automatically gets a correct,
  // unique canonical tag the moment it's added to store.js, with
  // zero manual SEO setup required per item.
