/* =============================================
   ...
   pages, not the /blog/ and /tools/ article pages.
...
export const GLOSSARY = [
  ...
  { term: 'Resume/CV', category: 'Career', def: 'A formal document summarizing work history, skills, and education.', girlie: 'Your professional highlight reel on paper.', example: 'A one-page resume tailored to a specific role.', why: 'Still a key first filter in most hiring processes.', related: ['Applicant Tracking System'], learn: [{ label: 'Resume Review Checklist', href: '/tools/resume-review-checklist.html' }] },
